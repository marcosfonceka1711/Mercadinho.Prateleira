...
{
    public class DeleteCategoryCommandHandler : IRequestHandler<UpdateCategoryCommand, bool>
    {
        ...
        {
            var categoria = await _categoriaRepository.GetByKeysAsync(cancellationToken, request.Id).ConfigureAwait(false);
